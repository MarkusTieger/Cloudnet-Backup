...
public record MySQLConnectionConfig(boolean enable, String uri, String username, String password, boolean useSsl, String database,
		HostAndPort address, String driver, Map<String, String> options,
		int minimumIdle, // 2
	...
	public MySQLConnectionConfig(boolean b, String defaultUri, String string, String string2, boolean c, String string3,
			HostAndPort hostAndPort, String defaultDriver, Map<String, String> defaultOptions) {
		this(b, defaultUri, string, string2, c, string3, hostAndPort, defaultDriver, defaultOptions, 2, 100, 10000, 4000, 10000);
	}
